		...
		authorized.Use(middleware.AuthMiddleware())
		{
			...
			wallet := authorized.Group("/wallet")
			{
				wallet.POST("/mnemonic/generate", func(c *gin.Context) {
					c.JSON(200, gin.H{"data": gin.H{"mnemonic": "abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about"}})
				})
